...
public class OrderService {
    ...
    public List<Order> getAllWithProducts() {
        List<Order> orders = orderRepository.findAll();
        // Принудительно инициализируем коллекцию пока сессия открыта
        orders.forEach(o -> o.getProducts().size());
        return orders;
    }
